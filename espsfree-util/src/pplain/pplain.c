...
#include <stdio.h>
/* RLS: Attempt to get rid of 'incompatible implicit declaration' warnings */
/* (works, but results in 'conflicting types for 'calloc'' error */
/* ('calloc' problem solved by commenting out calloc definition below) */
#include <stdlib.h>
#include <string.h>
/* End of additions */
#include <ctype.h>
...
char  **argv;
{
    ...
    /* bail on pc wave, and esignal input files */
    if (get_esignal_hdr(h) || get_pc_wav_hdr(h))  {
